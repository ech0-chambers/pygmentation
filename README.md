...
For example, in the Nord colour scheme - [https://www.nordtheme.com/](https://www.nordtheme.com/) - one of the accent colours is this red: ![#BF616A](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/0.svg). This is the 'base' for this colour family. There are then 5 variants, labelled `1` to `5`, which are as follows:
- `1`: ![#DBA5AA](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/1.svg)
- `2`: ![#CD838A](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/2.svg)
- `3`: ![#983E46](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/3.svg)
- `4`: ![#7E333A](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/4.svg)
- `5`: ![#63282E](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/5.svg)

Although the exact shades differ depending on the scheme (as discussed in the later sections), they will always be organised such that `1` has the most contrast with the background colour (which is in this case ![#2E3440](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/6.svg)) and `5` will have the least contrast. For dark colour schemes, this means that they are ordered from light to dark; for light schemes, from dark to light.
...
|---------|-----------|------------------------------------------------------------|------------------------------------------------------------|
| Red    | 0&deg;    | ![#BD0000](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/7.svg) | ![#D52A2A](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/8.svg) |
| Orange | 30&deg;   | ![#BD5F00](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/9.svg) | ![#D5802A](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/10.svg) |
| Yellow | 50&deg;   | ![#BD9D00](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/11.svg) | ![#D5B82A](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/12.svg) |
| Green  | 120&deg;  | ![#00BD00](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/13.svg) | ![#2AD52A](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/14.svg) |
| Cyan   | 180&deg;  | ![#00BDBD](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/15.svg) | ![#2AD5D5](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/16.svg) |
| Blue   | 240&deg;  | ![#0000BD](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/17.svg) | ![#2A2AD5](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/18.svg) |
| Purple | 270&deg;  | ![#5E00BD](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/19.svg) | ![#802AD5](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/20.svg) |
| Magenta| 300&deg;  | ![#BD00BD](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/21.svg) | ![#D52AD5](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/22.svg) |
...
All aliases will be assigned, although some aliases may be assigned to the same colour (for example in the Nord theme, `purple` and `magenta` both refer to the same colour: ![#B48EAD](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/23.svg)). Aliases are then accessible by (for example) `scheme.red.base` or `scheme.error.base`.
...
However, the perceived visual change between a hue of 100&deg; (![#55ff00](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/24.svg)) and a hue of 130&deg; (![#00ff2b](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/25.svg)) is clearly significantly less than the change between a hue of 260&deg; (![#5500ff](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/26.svg)) and a hue of 290&deg; (![#d400ff](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/27.svg)), despite the fact that the separation in the HSL colour space is the same. The L\*ab colour space is designed to be perceptually uniform, and it is much closer to achieving this goal than the RGB or HSL colour spaces. However, it is not actually perceptually uniform, so the CIEDE2000 algorithm includes a number of corrections to account for this. This will never be perfect, but it produces noticeably better results (even for such a relatively simple task) than directly using RGB (as many projects do) or other colour spaces.
...
| Variant | Modification   | Basic | With Foreground/Background |
| ------- | -------------- | ----- | -------------------------- |
| 1       | $50\%$ lighter | ![#DFB0B4](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/28.svg) | ![#DBA5AA](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/1.svg) |
| 2       | $25\%$ lighter | ![#CF898F](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/30.svg) | ![#CD838A](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/2.svg) |
| base    | -              | ![#BF616A](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/0.svg) | ![#BF616A](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/0.svg) |
| 3       | $40\%$ darker  | ![#7B3239](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/34.svg) | ![#983E46](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/3.svg) |
| 4       | $60\%$ darker  | ![#522126](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/36.svg) | ![#7E333A](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/4.svg) |
| 5       | $80\%$ darker  | ![#291113](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/38.svg) | ![#63282E](https://github.com/ech0-chambers/pygmentation/blob/main/.swatches/5.svg) |
